...
namespace IniFileParser
{
    ...
    /// </summary>
    public class IniStreamParser
    {
        /// <summary>
        ///     This instance will handle ini data parsing and writing
        /// </summary>
        public IniStringParser Parser { get; protected set; }

        /// <summary>
        ///     Ctor
        /// </summary>
        public IniStreamParser() : this (new IniStringParser()) {}

        /// <summary>
        ///     Ctor
        /// </summary>
        /// <param name="parser"></param>
        public IniStreamParser(IniStringParser parser)
        {
            Parser = parser;
        }
