...
namespace IniFileParser.Model
{
    ...
    public class IniData : ICloneable
    {
        ...
        public IniParserConfiguration Configuration
        {
            ...
            {
                // Lazy initialization
                return _configuration ?? (_configuration = new IniParserConfiguration());
            }
        ...
        {
            return TryGetKey(key, out string result) ? result : null;
        }

        /// <summary>
        ///     Merge the sections into this by overwriting this sections.
        /// </summary>
        public void MergeSection(SectionData otherSection)
        {
        ...
        /// </summary>
        public void MergeGlobal(KeyDataCollection globals)
        {
